...
| maxHeight            | Number   | Sets the maximum height in `percentage` of the component card with a `maximum` value of `100` and a `minimum` value of `10`                                                     | `:max-height="90"`                               | 80                   |
| maxWidth             | Number   | Sets the maximum width of the component card in `pixels`                                                                                                                        | `:max-width="80"`                                  | 576                  |
